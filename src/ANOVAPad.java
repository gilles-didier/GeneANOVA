 ...
 */
class ANOVAPad extends StandardPad {
    ...
    private Action[] defaultActions = {
 	...
 	class SaveAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			File f = GeneralUtil.getFileSaveAs(ANOVAPad.this);
			...
			if (f.exists()) {
				try {
					...
					((ANOVACompute.ANOVATableModel) getModel()).act, 0);
					out.close();
				} catch(IOException ioe){
					GeneralUtil.showError(ANOVAPad.this, "IO error : \n"+ioe);
				}
			}
		}		
	}
