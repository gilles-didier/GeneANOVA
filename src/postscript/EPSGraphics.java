...
public class EPSGraphics extends java.awt.Graphics
{
  ...
  */
  ...
  public EPSGraphics(Rectangle c)
  {
    this(c, new OutputStreamWriter(System.out), true);
  }
  ...
  public EPSGraphics(Rectangle c, Writer w)
  {
    this(c, w, true);
  }
  ...
  public EPSGraphics(Rectangle c, Writer w, boolean emitProlog)
  {
    setOutput(w);
    clippingRect = c;
    if (emitProlog)
  ...
  public void drawString(String str, int x, int y) 
  {
    ...
    if (DEBUG) diagnostic("drawString(iterator)");
    y = transformY(y);
    moveto(x, y);
    os.print(" (");
    os.println(") show stroke");
  ...
  */
  ...
  protected void emitProlog() 
  {
    ...
    os.println("%%Title: GeneAnova");
    os.println("%%Creator: LGI Package for Genes Expression Analysis");
    os.println("%%CreationDate: sometimes");
    os.println("%%For: yourself");
    os.println("%%Pages: 1");
    os.println("%%DocumentFonts: Helvetica SansSerif");
    os.println("%%BoundingBox: "+Integer.toString(clippingRect.x)+" "+Integer.toString(clippingRect.y)+" "+Integer.toString(clippingRect.width)+" "+Integer.toString(clippingRect.height));
    os.println("%%EndComments");
    os.println("%%BeginProlog");
    os.println("% Use own dictionary to avoid conflicts");
    os.println("5 dict begin");
    os.println("%%EndProlog");
    os.println("%%Page: 1 1");
/*    os.println("save");
    os.println("countdictstack");
    os.println("mark");
    os.println("newpath");
    os.println("/showpage {} def");
    os.println("%%EndProlog");
    os.println("%%Page 1 1");
*/
